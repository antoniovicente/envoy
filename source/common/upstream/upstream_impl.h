...
public:
  ...
  // Upstream::Host
  std::vector<std::reference_wrapper<const Stats::SimpleCounter>> counters() const override { return stats_.counters(); }
  ...
  std::vector<std::reference_wrapper<const Stats::SimpleGauge>> gauges() const override { return stats_.gauges(); }

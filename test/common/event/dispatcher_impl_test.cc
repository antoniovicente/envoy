...
TEST_F(SchedulableCallbackImplTest, ScheduleAndCancel) {
  ...
  cb->scheduleCallback(Event::SchedulableCallback::ScheduleType::CurrentLoopIteration);
...
TEST_F(SchedulableCallbackImplTest, ScheduleOrder) {
  ...
  callbacks_[0]->scheduleCallback(Event::SchedulableCallback::ScheduleType::CurrentLoopIteration);
  callbacks_[1]->scheduleCallback(Event::SchedulableCallback::ScheduleType::CurrentLoopIteration);
...
TEST_F(SchedulableCallbackImplTest, ScheduleChainingAndCancellation) {
  ...
  createCallback([&]() {
    watcher1.ready();
    callbacks_[2]->scheduleCallback(Event::SchedulableCallback::ScheduleType::CurrentLoopIteration);
    callbacks_[3]->scheduleCallback(Event::SchedulableCallback::ScheduleType::CurrentLoopIteration);
    callbacks_[4]->scheduleCallback(Event::SchedulableCallback::ScheduleType::CurrentLoopIteration);
  });
